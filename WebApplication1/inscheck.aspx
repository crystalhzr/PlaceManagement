<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="inscheck.aspx.cs" Inherits="WebApplication1.inscheck" %>
        ...
        <div class="vmenu">    
            ...
            <div class="apply">
                ...
                <Columns>
                    ...
                    <asp:CommandField ButtonType="Button" DeleteText="通过" HeaderText="指导老师" ShowCancelButton="False" ShowDeleteButton="True" UpdateText="">
