...
{
    public partial class inscheck : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string cmdstr = "UPDATE [checked] SET [inscheck]='" + "通过审核" + "'where [sno]='" + GridView1.Rows[e.RowIndex].Cells[0].Text + "'AND [sdept]='" + GridView1.Rows[e.RowIndex].Cells[1].Text + "'";
