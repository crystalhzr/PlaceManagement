<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comcheck.aspx.cs" Inherits="WebApplication1.check" %>
        ...
        <div class="vmenu">    
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="sno" CellPadding="4" ForeColor="#333333" GridLines="None" OnRowDeleting="GridView1_RowDeleting"  >
                ...
                <Columns>
                    ...
                    <asp:CommandField ButtonType="Button" HeaderText="社管部" NewText="通过" ShowCancelButton="False" DeleteText="通过" ShowDeleteButton="True" >
                    <ControlStyle BackColor="Transparent" ForeColor="#950000" />
                    </asp:CommandField>
                </Columns>
