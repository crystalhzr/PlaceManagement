<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checking.aspx.cs" Inherits="WebApplication1.checking" %>
    ...
    <div class="main">
        <div class="vmenu">    
         ...
         <div class="apply">
             <br />
             <br />
            <div class="text">各校区场地审核情况：<asp:Button ID="Bt_all" runat="server" Text="全部校区" CssClass="cam_bt" OnClick="Bt_all_Click" />
                ...
                <asp:GridView ID="GV_all" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="comcheck" HeaderText="社管部审核" />
                        <asp:BoundField DataField="inscheck" HeaderText="指导老师审核" />
             ...
             <br />
             <br />
             <div class="text">场地具体审核过程：<asp:Button ID="Btc_all" runat="server" Text="全部" CssClass="cking_bt" OnClick="Btc_all_Click"/>
                 <asp:Button ID="Btc_com" runat="server" Text="通过社管部审核" CssClass="cking_bt" OnClick="Btc_com_Click"/>
                 <asp:Button ID="Btc_ins" runat="server" Text="通过指导老师审核" CssClass="cking_bt" OnClick="Btc_ins_Click"/>
                 <hr/>
             </div>
                 <asp:GridView ID="Gcall" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="sno" HeaderText="姓名" />
                        <asp:BoundField DataField="sdept" HeaderText="所在单位" />
                ...
                <asp:GridView ID="Gccom" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="sno" HeaderText="姓名" />
                        <asp:BoundField DataField="sdept" HeaderText="所在单位" />
                ...
                <asp:GridView ID="Gcins" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False">
                    <AlternatingRowStyle BackColor="White" />
                    <Columns>
                        <asp:BoundField DataField="sno" HeaderText="姓名" />
                        <asp:BoundField DataField="sdept" HeaderText="所在单位" />
